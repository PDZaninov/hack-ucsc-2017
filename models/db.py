...
# extra fields
auth.settings.extra_fields['auth_user'] = [Field('point', 'integer', default='0')]
...
class googleAccount(OAuthAccount):
    ...
    client_id = "4804650248-vjk3po1br4nl34d283ric8jbmhrmkte0.apps.googleusercontent.com"
    client_secret = "ToAxFnL-s11WFioLSLcMGq4r"
...
auth.settings.actions_disabled = ['request_reset_password', 'register', 'profile', 'change_password', 'password']